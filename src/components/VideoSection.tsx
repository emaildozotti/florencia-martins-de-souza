...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Preciso te contar',
  headingEm: 'uma coisa.',
  preText: 'Por anos, eu busquei respostas nos mesmos lugares que você. Até que descobri que o problema não estava nas palavras. Estava no que o inconsciente gravou sem que eu soubesse.',
  postText: 'Entender isso mudou tudo pra mim. E pode mudar pra você também.',
}
// ════════════════════════════════════════════════════════════════════
