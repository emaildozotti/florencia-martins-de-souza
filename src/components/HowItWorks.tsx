...
const COPY = {
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'À medida que os registros são limpos, os sintomas perdem força. O peito para de apertar, o medo diminui, a estagnação solta. Você percebe a mudança no corpo antes mesmo de encontrar palavras pra ela.',
    },
  ],
  note: 'O processo é conduzido com respeito ao seu tempo e sem interromper tratamentos médicos em andamento.',
  ctaText: 'Agendar minha conversa inicial gratuita',
}
// ════════════════════════════════════════════════════════════════════
